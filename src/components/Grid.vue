...
export default {
    ...
    data () {
        return {
            ...
            // no. of moves played by both players in a single agme (max=9)
            moves: 0,
            // stores the placement of X and 0 in cells by their cell number
              cells: {
                1: '', 2: '', 3: '',
                4: '', 5: '', 6: '',
                7: '', 8: '', 9: ''
    ...
    created: function () {
      // listens for a strike made by the sure on cell
      ...
      Event.$on('strike', (cellNumber) => {
          ...
          // stores the game status by caling the changeGameStatus method
    ...
    methods: {
        ...
        gameIsWon() {
            ...
            Event.$emit('win', this.activePlayer)
                console.log('Logging the winning player')
